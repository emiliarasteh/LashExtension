<div class="gtco-cover gtco-cover-sm" style="background-image: url(/assets/mytemplate/images/img_bg_1.jpg)"  data-stellar-background-ratio="0.5">
    <div class="overlay home-footer-image"></div>
    <div class="gtco-container text-center">
        <div class="display-t">
            <div class="display-tc">
                <h1>&ldquo; Clear Lipgloss, Lash Extensions and a Fresh Face. It's a look, It's a mood, It's a vibe!&rdquo;</h1>
            </div>
        </div>
    </div>
</div>
